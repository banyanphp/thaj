            ...
            <section class="page-sidebar page-section-ptb">
                ...
                <div class="container" style="background-color:#F5F5F5">
                    ...
                    <div class="row">
                        ...
                        <h3 class="text-blue text-center" style="margin-bottom:1%">Reschedule an Appointment</h3>
...
$pid=$_SESSION['pid'];
    ...
    ?></li>
                                                        ...
                                                        <input type="hidden" value="<?php  echo $timeslott; ?>" id="timeslots" >
                                                        <input type="hidden" value="<?php  echo $todaydate; ?>" id="dates" >

                                                        <button  class="btn btn-info heading14" onclick="update(<?php echo $pid; ?>)">Appointment Reschedule</button>
