...
if($_POST && isset($_POST['submit'])){
   ...
   // $url = $transactionRequestBean->getTransactionToken();
    ...
    if(is_string($response) && preg_match('/^msg=/',$response)){
        ...
        $payment_o_response_update = mysql_query("update tbl_patientlist set payment_o_response='$response' where fld_id ='$p_id'")or die(mysql_error());
