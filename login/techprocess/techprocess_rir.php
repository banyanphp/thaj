...
if($_POST && isset($_POST['submit'])){
   ...
   // $url = $transactionRequestBean->getTransactionToken();
    ...
    if(is_string($response) && preg_match('/^msg=/',$response)){
        ...
        $payment_refund_response_update = mysql_query("update tbl_patientlist set payment_refund_response='$response' where fld_id ='$p_id'")or die(mysql_error());
...
<?php
$root_url  	 = 'http://drthajskin-haironlineexpert.in/admin/';
if($payment_refund_response_update)
{
?>
