       ...
       <div class="row"> 
        <div class="col-md-12"> 
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"> <img id="logo_img" src="logo.png" alt=""></a>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="javascript:void(0);" class="page-scroll">Login</a></li>
              <li><a href="javascript:void(0);" class="page-scroll" style="background-color: #00a9da;color: white;padding: 12px 16px 10px 13px;">Signup</a></li>
...
<div class="rev-slider-2" style="background-image:url(images/slider/slider-02.jpg)">
 <div class="tp-banner-container">
    ...
    width: 344px;">
                 <label for="phone" style="color:#fff;">Appointment *</label>
                  <div class="field-widget">
				   ...
				   <button class="btn btn-primary" data-toggle="modal" data-target="#myModal-supplier" onclick="fn_check(<?php echo $supplierid; ?>);" style="background-color: #A61F3D;
    color: #fff;width: 42%; margin-top: 3%;">Consult Now</button>
	...
	<button class="btn btn-primary" data-toggle="modal" data-target="#myModal-supplier" onclick="fn_check(<?php echo $supplierid; ?>);" style="background-color: #A61F3D;
    color: #fff;width: 54%; margin-top: 3%;">Schedule Appointment</button>
                  </div>
  ...
  <div class="team">
   <div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6">
       <div class="team-box">
        <img alt="" src="images/team/01.jpg" class="img-responsive"> 
          <div class="team-overlay text-center"> 
              <div class="info">
                 <h5 class="text-white">Martin Smith</h5>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6">
       <div class="team-box">
        <img alt="" src="images/team/04.jpg" class="img-responsive"> 
          <div class="team-overlay text-center"> 
              <div class="info">
                 <h5 class="text-white">Martin Smith</h5>
               <span>web designer</span>
     ...
     <div class="row">
       <div class="col-lg-4 col-md-4 col-sm-4">
         <div class="get-in-touch">
           ...
           <p class="text-white pt-20 pb-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime, vitae? Possimus delectus ex, harum, quis rerum maxime in magnam.</p>
         </div>
         <div class="contact-add">
           <i class="fa fa-map-marker"></i>
           <p class="text-white">1234 North Avenue Luke Lane South Bend, IN 360001</p>
         </div>
         <div class="contact-add">
