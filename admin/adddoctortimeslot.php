...
if (!empty($_POST['timeslot'])&&(!empty($_POST['from']))&&(!empty($_POST['TO']))){
if (!empty($_POST['timeslot'])) {
   ...
   echo "<script>window.location.href='doctortimeslot.php'; </script>";
    }
}
...
if($timeslotcount==0)
    {
      ...
      echo "<script>window.location.href='doctortimeslot.php?timeslot=$totaltime'; </script>";
}
