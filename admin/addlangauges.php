            ...
            <div class="main_content">
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="heading">Add Langauges</h3>
                        <form id="form1" name="form1" method="post" enctype="multipart/form-data">	
                            ...
                            <div id="prods" style="float:left" class="span6">
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        <label>Add Langauges <span class="f_req">*</span></label>	
                                        <input  type="text" name="langauges" id="langauges" class="span8"/>
...
$('.success').html('');
   ...
   setTimeout(function () {
                            $('#success').hide();
                         window.location.href='langauges.php';
                        }, 1000);
}  
});
}
