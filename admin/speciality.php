                    ...
                    <div class="row-fluid">
                        <div class="span12">
						  ...
						  <div id="response"style="margin-left:60%"></div>
                                                  ...
                                                  <input class="btn btn-inverse" type="button" id="btnedit" onclick="window.location.href='addspeciality.php'" value="Add Speciality" style="margin-left: 90%;margin-bottom: 2%;"/>
									...
									<div class="row-fluid">
										<div class="span12" style="width:206%;">										
											<table style="border:1px solid;" class="table table-striped table-bordered table-hover">
												...
												<tbody>
											<?php
											$seldc = "SELECT * from tbl_specialities ";
											...
											$fld_specialities = $row['fld_specialities'];	
