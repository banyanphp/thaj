...
<html lang="en">
    <head>
        ...
        <title>Past Patient List | Dashboard</title>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
						  <div id="response"style="margin-left:60%"></div>
							<h3 class="heading">Past Patient List</h3>
									...
									<div class="row-fluid">
										<div class="span12" style="width:206%;">										
											...
											<?php
                                                                                     	...
                                                                                     	$seldc = "SELECT * from `tbl_patientlist` where consultant_date<'$todaydate'  and payment_status='1' or consultant_date='$todaydate'  and fld_enddatetime<'$current_times' and payment_status='1'";
       
											
                                                                                        }
                                                                                            else {
                                                                                               $seldc = "SELECT * from `tbl_patientlist` where fld_dcname ='$doctor_id'and payment_status='1'";
