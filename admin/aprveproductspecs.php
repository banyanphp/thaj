...
$viewemail=$_SESSION['pstemail'];
							...
							<div id="prodspecs">							
								 <form id="form3" name="form3" method="post">
                                   ...
                                   while($row=mysql_fetch_array($refinesubminicatproduct11,MYSQL_ASSOC))
                                    {                                        
										...
										$queryyyy = "select * from $filtertable where fld_prodid='$proddid'"; 
    							...
    							{   
									...
									$querry1 = "select distinct $columnnames[$f] from $filtertable where fld_prodid='$proddid'"; 
									...
									{
									echo '<input type="text" id="fld_price" name="fld_price" class="span8" value="'.$refarray[$p].'">';
									}													
									else if($columnnames[$f]=="fld_description")
									{
									echo '<textarea name="fld_description" id="fld_description" cols="10" rows="2" class="span8">'.$refarray[$p].'</textarea>';
									}
