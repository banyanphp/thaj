...
<html lang="en">
    <head>
        ...
        <title>Refund Initiation Request | Dashboard</title>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
						  <div id="response"style="margin-left:60%"></div>
							<h3 class="heading">Refund Initiation Request Process</h3>
<?php 
...
?>
							<form id="form1" name="form1" method="post" action="<?php echo $root_url.'techprocess/techprocess_rir.php'; ?>">	
							
		<table class="table table-striped table-bordered">
	<input type="hidden" name="pd_id" id="pd_id" value="<?php echo (isset($pd_id) && !empty($pd_id)) ? $pd_id : ''; ?>"/>
	<input type="hidden" name="reqType" id="reqType" value="R"/>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" class="form-control" name="amount" value="<?php echo (isset($payment_request->amount) && !empty($payment_request->amount)) ? (int)$payment_request->amount : ''; ?>"/></td>
    </tr>
    <tr>
